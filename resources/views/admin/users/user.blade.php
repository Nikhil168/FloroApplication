                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <div class="form-group row justify-content-md-center">
                                ...
                                <div class="col-md-4">
                                    <input id="user_name" type="text" class="form-control{{ $errors->has('user_name') ? ' is-invalid' : '' }}" name="user_name" value="{{ isset($user) ? $user->user_name : old('user_name') }}" required autofocus>
                            ...
                            <div class="form-group row justify-content-md-center">
                                ...
                                <div class="col-md-4 checkbox-field">
                                    ...
                                    <input id="status" type="checkbox" class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status" value="1"  {{ isset($user) ? (($user->status) ? 'checked' : '') :  'checked' }}>
